<?php
	...
	*/
	...
	function aes256Encrypt2($key, $data, $mode = MCRYPT_MODE_CBC, $block_size = MCRYPT_RIJNDAEL_256) {
	...
	function aes256Decrypt2($key, $data, $mode = MCRYPT_MODE_CBC, $block_size = MCRYPT_RIJNDAEL_256) {
		$cipher = mcrypt_module_open($block_size, '', $mode, '');
		$iv_size = mcrypt_enc_get_iv_size($cipher);
		$iv_dec = substr($data, 0, $iv_size);
